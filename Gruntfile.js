		...
		combine: {
			single: {
				...
				tokens: [
					...
					{ token: "//jquery.js", file: "./src/jquery-3.3.1.min.js"},
					{ token: "//particles.js", file: "./src/particles.js"},
					{ token: "//particles.config.js", file: "./src/particles.config.js"},
					{ token: "//main.js", file: "./src/main.js"},
					{ token: "//materialize.js", file: "./src/materialize.js" },
					{ token: "//main.css", file: "./src/main.css" },
					{ token: "//materialize.css", file: "./src/materialize.css" },
					{ token: "//animate.css", file: "./src/animate.css" },
